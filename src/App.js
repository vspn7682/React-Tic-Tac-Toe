...
const itemsArray = new Array(9).fill('')
...
const App = () => {
  ...
  const checkWinner = () => {
          if (itemsArray[0] === itemsArray[1] && itemsArray[0] === itemsArray[2] && itemsArray[0] !== '') {
            setWinMessage(`${itemsArray[0]} wins`)
          } else if (itemsArray[3] === itemsArray[4] && itemsArray[3] === itemsArray[5] && itemsArray[3] !== '') {
            setWinMessage(`${itemsArray[3]} wins`)
          } else if (itemsArray[6] === itemsArray[7] && itemsArray[6] === itemsArray[8] && itemsArray[6] !== '') {
            setWinMessage(`${itemsArray[6]} wins`)
          } else if (itemsArray[0] === itemsArray[3] && itemsArray[0] === itemsArray[6] && itemsArray[0] !== '') {
            setWinMessage(`${itemsArray[0]} wins`)
          } else if (itemsArray[1] === itemsArray[4] && itemsArray[1] === itemsArray[7] && itemsArray[1] !== '') {
            setWinMessage(`${itemsArray[1]} wins`)
          } else if (itemsArray[2] === itemsArray[5] && itemsArray[2] === itemsArray[8] && itemsArray[2] !== '') {
            setWinMessage(`${itemsArray[2]} wins`)
          } else if (itemsArray[0] === itemsArray[4] && itemsArray[0] === itemsArray[8] && itemsArray[0] !== '') {
            setWinMessage(`${itemsArray[0]} wins`)
          } else if (itemsArray[2] === itemsArray[4] && itemsArray[2] === itemsArray[6] && itemsArray[2] !== '') {
            setWinMessage(`${itemsArray[2]} wins`)
          } 
  }
    ...
    <Container>
      ...
      <Row>
        <Col md={6}>
          {winMessage ? (
            <div>
              <h2 className='subheading'>{winMessage}</h2>
              <button onClick={reloadGame} className="btn">Reload Game</button>
            </div>
          ) : (
              <div>
                <h2 className="subheading">{isCross ? 'Cross' : 'Circle'} turn</h2>
              </div>
          )}
          <div className="board">
